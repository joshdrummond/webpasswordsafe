...
public class CasSsoAuthenticator implements SsoAuthenticator
{
    ...
    {
        String principal = "";
        HttpServletRequest request = ServerSessionUtil.getRequest();
        if (request.getUserPrincipal() != null)
        {
            AttributePrincipal ssoPrincipal = (AttributePrincipal) request.getUserPrincipal();
            principal = ssoPrincipal.getName();
            LOG.debug("CasSsoAuthenticator principal="+principal);
        }
        return principal;
    }
